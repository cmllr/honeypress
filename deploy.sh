...
function show_help() {
    ...
    echo "deploy.sh -l label1=value1,label2=value2: Add labels to the honeypress container. Use ',' to separate labels, avoid separator in labels. Escape backticks. Defaults to nothing."
